...
<section class="text-gray-600 body-font relative" style="user-select: auto; background-color: rgb(191, 221, 241);">
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap -m-4">
      <div class="lg:w-2/2 lg:mb-0 mb-6 p-4">
        <div class="h-full text-center">
          ...
          <a class="fa fa-linkedin" style="font-size:40px" href="https://www.linkedin.com/in/mala-neeraj-srinivas-26217a228/" target="_blank"></a>
        </div>
      </div>
    </div>
  </div>
